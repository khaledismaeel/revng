...
function(tuple_tree_generator_compute_generated_cpp_files SCHEMA_PATH
  ...
  execute_process(
    COMMAND "${SCRIPTS_ROOT_DIR}/tuple-tree-generate-cpp-paths.py"
            "${SCHEMA_PATH}" "${HEADERS_DIR}"
    RESULT_VARIABLE GENERATE_PATHS_EXIT_CODE
    OUTPUT_VARIABLE GENERATED_PATHS
    ERROR_VARIABLE GENERATE_PATHS_STDERR)

  if(NOT "${GENERATE_PATHS_EXIT_CODE}" EQUAL "0")
    message(
      FATAL_ERROR
        "the script for computing the list of generated paths has failed." "\n"
        "${GENERATE_PATHS_STDERR}")
  endif()

  list(LENGTH GENERATED_PATHS LIST_LENGTH)
  math(EXPR LIST_LENGTH_M_1 "${LIST_LENGTH} - 1")
  list(SUBLIST GENERATED_PATHS "0" "${LIST_LENGTH_M_1}"
       LOCAL_GENERATED_HEADERS_VARIABLE)
  list(GET GENERATED_PATHS "${LIST_LENGTH_M_1}" LOCAL_GENERATED_IMPLS_VARIABLE)
...
# SCHEMA_PATH Path to single YAML schema
